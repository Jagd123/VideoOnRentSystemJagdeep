USE [master]
GO
/****** Object:  Database [VideoOnRentSystemJagdeepDB]    Script Date: 01-02-2021 22:46:11 ******/
CREATE DATABASE [VideoOnRentSystemJagdeepDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'VideoOnRentSystemJagdeepDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\VideoOnRentSystemJagdeepDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'VideoOnRentSystemJagdeepDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\VideoOnRentSystemJagdeepDB_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET COMPATIBILITY_LEVEL = 150
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [VideoOnRentSystemJagdeepDB].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET ARITHABORT OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET  ENABLE_BROKER 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET RECOVERY FULL 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET  MULTI_USER 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET DB_CHAINING OFF 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET DELAYED_DURABILITY = DISABLED 
GO
EXEC sys.sp_db_vardecimal_storage_format N'VideoOnRentSystemJagdeepDB', N'ON'
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET QUERY_STORE = OFF
GO
USE [VideoOnRentSystemJagdeepDB]
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 01-02-2021 22:46:11 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Movies]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RentedMovies]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[CustomerAndMoviesRented]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[MostPopular]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[IssueCount]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ORDER BY Expr1 DESC
GO
/****** Object:  View [dbo].[MaxMostpopular2]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP BY dbo.Movies.Title
GO
/****** Object:  View [dbo].[MaxMostPopular]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP BY dbo.Movies.Title
GO
/****** Object:  View [dbo].[View_1]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP BY dbo.Movies.Title
GO
/****** Object:  View [dbo].[IssuesReturns]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
FROM            dbo.Customer INNER JOIN
                         ...
                         dbo.Movies ON dbo.RentedMovies.MovieIDFK = dbo.Movies.MovieID
GO
/****** Object:  View [dbo].[NotReturned]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Overdue]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP BY dbo.RentedMovies.RMID, DATEDIFF(day, dbo.RentedMovies.DateRented, GETDATE()), dbo.RentedMovies.DateRented, dbo.Customer.FirstName, dbo.Customer.LastName, dbo.Customer.Phone, dbo.Movies.Title, 
                         dbo.Customer.CustID
GO
/****** Object:  View [dbo].[OverdueMovies]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1506, N'Zeb', N'O''Donnell', N'52 Greenhurst St', N'3871209')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1507, N'Margaret', N'Pearl', N'29 Oyster Lane', N'5097382')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1508, N'Reggie', N'Chino', N'221 High Rd', N'4972487')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1509, N'Fred', N'Flinstone', N'Bedrock', N'0000000')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1510, N'Simon', N'Fitzpatrick', N'123 Halleys Rd', N'4872938')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1511, N'Ian', N'Summers', N'24 Summit View', N'387487')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1512, N'Susan', N'Sanders', N'45 Moana Dr', N'1897775')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1513, N'Colin', N'Crane', N'8 Seal Dr', N'3847910')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1515, N'Mary', N'Poppins', N'Cherry Tree Lane', N'42948459')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1517, N'Martin', N'Blake', N'Hoovers Hill', N'0934598')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1518, N'Marjory ', N'Dawe', N'45 Seesaw Lane', N'8724238')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1522, N'Peter', N'Piper', N'Peppertree Rd', N'9487529')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1524, N'Sam ', N'Jong', N'abc', N'2589632587')
GO
INSERT [dbo].[Customer] ([CustID], [FirstName], [LastName], [Address], [Phone]) VALUES (1525, N'Kamal', N'Singh', N'qwerty', N'4857576565')
GO
...
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (14, N'Not Rated', N'8A½', N'1963', 2.0000, N'', N'A harried movie director retreats into his memories and fantasies.', N'Drama, Fantasy')
GO
...
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (194, N'R', N'The Godfather: Part III', N'1990', 2.0000, N'', N'In the midst of trying to legitimize his business dealings in 1979 New York and Italy, aging mafia don Michael Corleone seeks to vow for his sins while taking a young protÃ©gÃ© under his wing.', N'Crime, Drama, Mystery')
GO
...
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (198, N'N/A', N'Shark', N'2006â€“2008', 2.0000, N'', N'Title character Sebastian Stark is an L.A. hot-shot lawyer, who leaves his lucrative career as defender of rich criminals to join the public prosecution under the District Attorney (D.A.), ...', N'Crime, Drama, Mystery')
GO
...
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (219, N'N/A', N'Dream Well', N'2009', 2.0000, N'', N'Regina, the once popular girl has to make new friends at her new, conservative school. Problems arrive when she becomes enemies with LÃ­via, the school''s queen bee, and falls in love with ...', N'Comedy, Romance, Sport')
GO
...
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (233, N'R', N'LÃ©on: The Professional', N'1994', 2.0000, N'', NULL, NULL)
GO
...
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (446, N'PG-13', N'Les MisÃ©rables', N'2012', 5.0000, N'', NULL, NULL)
GO
...
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (539, N'R', N'The Hillz', N'2004', 2.0000, N'5', N'A promising college athlete takes a turn for the worse when he hooks up with old highschool friends during his summer break.', N'Crime, Drama')
GO
...
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (541, N'M', N'Boy', N'2010.', NULL, NULL, N'A New Zealand youth (James Rolleston) finds that his father (Taika Waititi) is a far cry from the heroic adventurer he''s imagined the man to be.', N'Comedy/Drama')
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (549, N'PG-13', N'Guns of Navarone', N'1961', NULL, NULL, N'A British team is sent to cross occupied Greek territory and destroy the massive German gun emplacement that commands a key sea channel.', N'Action/Drama')
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (550, N'PG-13', N'Brooklyn', N'2015', NULL, NULL, N'An Irish immigrant lands in 1950s Brooklyn, where she quickly falls into a romance with a local. ... ', N'Drama/Romance')
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (551, N'5', N'Race', N'2011', 2.0000, N'5', N'uhg', N'Action')
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (552, N'5', N'Race', N'2015', 5.0000, NULL, N'abc', N'Action')
GO
INSERT [dbo].[Movies] ([MovieID], [Rating], [Title], [Year], [Rental_Cost], [Copies], [Plot], [Genre]) VALUES (553, N'5', N'Hum trum', N'1990', 2.0000, N'4', N'qwer', N'Romance')
GO
SET IDENTITY_INSERT [dbo].[Movies] OFF
GO
SET IDENTITY_INSERT [dbo].[RentedMovies] ON 
GO
INSERT [dbo].[RentedMovies] ([RMID], [MovieIDFK], [CustIDFK], [DateRented], [DateReturned]) VALUES (34, 6, 6, CAST(N'2019-11-30T22:33:03.723' AS DateTime), CAST(N'2019-11-30T22:33:15.410' AS DateTime))
GO
INSERT [dbo].[RentedMovies] ([RMID], [MovieIDFK], [CustIDFK], [DateRented], [DateReturned]) VALUES (35, 10, 5, CAST(N'2019-11-30T23:02:30.580' AS DateTime), CAST(N'2019-11-30T23:02:41.380' AS DateTime))
GO
...
GO
/****** Object:  StoredProcedure [dbo].[AddCustomer]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[IssueMovie]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[MovieIssue]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[ReturnMovie]    Script Date: 01-02-2021 22:46:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
USE [master]
GO
ALTER DATABASE [VideoOnRentSystemJagdeepDB] SET  READ_WRITE 
GO
